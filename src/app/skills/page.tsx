...
export const metadata: Metadata = {
  ...
  description: "Security, networking, programming, and infrastructure skills.",
};

export default function SkillsPage() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <p className="font-mono text-sm uppercase tracking-[0.2em] text-secondary">Capabilities</p>
